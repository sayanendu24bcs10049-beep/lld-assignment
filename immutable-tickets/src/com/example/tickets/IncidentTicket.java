...
public class IncidentTicket {
    ...
    /**
     * Return a new builder pre-populated from this ticket. Useful for creating
     * a modified copy while preserving immutability.
     */
    ...
    /**
     * Builder for {@link IncidentTicket}. All validation occurs in build().
     */
    public static class Builder {
        ...
        public IncidentTicket build() {
            ...
            // tags list may be null -> treated as empty
            return new IncidentTicket(this);
        }

        /**
         * Create a builder pre-populated from an existing ticket.
         */
